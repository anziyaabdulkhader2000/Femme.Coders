    ...
    return (
        ...
        <img src={img12} alt="Header-logo" />
            ...
            <nav className="header__nav">
                <ul className="header__list">
                    ...
                    <NavLink activeClassName="headeractive" to="/companies" className="header__items">Companies</NavLink>
                    <NavLink activeClassName="headeractive" to="/events" className="header__items">Events</NavLink>
                    <NavLink activeClassName="headeractive" to="/jobs" className="header__items">Jobs</NavLink>
        ...
        {user && <div className="hamburger__authentication">
            ...
            <NavLink activeClassName="headeractive" to="/home" onClick={() => setOpen(!open)} className="hamburger__items">Home</NavLink>
                    ...
                    <NavLink onClick={() => setOpen(!open)} activeClassName="headeractive" to="/companies" className="hamburger__items">Companies</NavLink>
                    <NavLink onClick={() => setOpen(!open)} activeClassName="headeractive" to="/events" className="hamburger__items">Events</NavLink>
                    <NavLink onClick={() => setOpen(!open)} activeClassName="headeractive" to="/jobs" className="hamburger__items">Jobs</NavLink>
